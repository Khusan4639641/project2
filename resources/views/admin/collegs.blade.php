                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-home-tab1" data-toggle="pill" href="#custom-tabs-four-home1" role="tab" aria-controls="custom-tabs-four-home1" aria-selected="false">Disable Collegs</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-messages-tab2" data-toggle="pill" href="#custom-tabs-four-messages2" role="tab" aria-controls="custom-tabs-four-messages2" aria-selected="false">Header text</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-messages-tab" data-toggle="pill" href="#custom-tabs-four-messages" role="tab" aria-controls="custom-tabs-four-messages" aria-selected="false">Add Collegs</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-four-messages2" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab2">
                                <form method="post" action="{{ route('sendCollegsHeader') }}" id="updateProfileForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <input type="hidden" name="type" value="slider" class="form-control col-sm-3"/>
                                        <div class="col-sm-12">
                                            <a type="submit" onclick="AjaxOnline1()" class="btn btn-info">
                                                Translate
                                            </a>
                                        </div>
                                        <div class="col-sm-4">
                                            <strong> Header in russian</strong>
                                            <textarea  id="header_ru_1" name="header[ru]" maxlength="255" class="form-control">{{ $sliders_header->head_ru }}</textarea>
                                        </div>
                                        <div class="col-sm-4">
                                            <strong> Header in Uzbek</strong>
                                            <textarea id="header_uz_1"  name="header[uz]" maxlength="255" class="form-control">{{ $sliders_header->head_uz }}</textarea>

                                        </div>
                                        <div class="col-sm-4">
                                            <strong> Header in English</strong>
                                            <textarea id="header_en_1" name="header[en]" maxlength="255" class="form-control">{{ $sliders_header->head_en }}</textarea>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                                <form method="post" action="{{ route('sendCollegs') }}" id="updateProfileForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <input type="hidden" name="type" value="slider" class="form-control col-sm-3"/>
                                        <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-12">
                                                <strong> Colleg name</strong>
                                                <input onclick='spaceDel(id)' id="header_ru" name="header[ru]" maxlength="255" class="form-control">
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <strong> Career type in russian</strong>
                                                <input id="short_ru" name="short[ru]" onclick='spaceDel(id)' maxlength="255" class="form-control">
                                        </div>
                                        <div class="col-sm-4">
                                            <strong> Career type in Uzbek</strong>
                                                <input id="short_uz" name="short[uz]" onclick='spaceDel(id)' maxlength="255" class="form-control">

                                        </div>
                                        <div class="col-sm-4">
                                            <strong> Career type in English</strong>
                                                <input id="short_en" name="short[en]" onclick='spaceDel(id)' maxlength="255" class="form-control">
                                        </div>

                                        <div class="col-sm-4">
                                            <strong> Comment in russian</strong>
                                            <textarea onclick='spaceDel(id)' id="full_ru" name="full[ru]" class="form-control"></textarea>
                                        </div>
                                        <div class="col-sm-4">
                                            <strong> Comment in Uzbek</strong>
                                            <textarea id="full_uz" name="full[uz]" onclick='spaceDel(id)' class="form-control"></textarea>

                                        </div>
                                        <div class="col-sm-4">
                                            <strong> Comment in English</strong>
...
//                        alert(data);
                        ...
                        document.getElementById("header_en").value = header_ru;
                        document.getElementById("header_uz").value = header_ru;
        ...
        function AjaxOnline1(){
            alert("Waiting for translate");
            var header_ru = document.getElementById("header_ru_1").value;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    document.getElementById("header_en_1").value = header_en;
                    document.getElementById("header_uz_1").value = header_uz;
