                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Clients</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-home-tab1" data-toggle="pill" href="#custom-tabs-four-home1" role="tab" aria-controls="custom-tabs-four-home1" aria-selected="false">Disable Clients</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-messages-tab" data-toggle="pill" href="#custom-tabs-four-messages" role="tab" aria-controls="custom-tabs-four-messages" aria-selected="false">Add Clients</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            ...
                            @foreach($sliders as $val)
                                <div class="slider" id="sliderId_{{ $num }}">
                                    <div class="headers" onclick="sliderShow({{ $num }})">
                                       <p class="slide_p"><strong>{{ $num }} )</strong>&nbsp;&nbsp;Blog {{ $val->id }}
                                    ...
                                    <div>
                                        ...
                                        <br/>
                                        <a href="/home/edit_show/client/{{ $val->id }}" class="btn btn-info" style="width: 100%;color: white;">Edit</a>
                                    </div>
                                </div>
                                <? $num++; ?>
                            @endforeach
                                ...
                                @foreach($sliders_dis as $val)
                                    <div class="slider" id="sliderId1_{{ $num1 }}">
                                        <div class="headers" onclick="sliderShow1({{ $num1 }})">
                                            <p class="slide_p"><strong>{{ $num1 }} )</strong>&nbsp;&nbsp;Blog {{ $val->id }} <a style="float: right;margin-top: -5px;color: white" href="/home/active/slider/{{ $val->id }}" class="btn btn-info">Active</a></p>
                                        </div>
                                        <div>
                                            <h4>Galery</h4>
                                            <div style="border:1px #ccc solid;min-height: 100px;width: 100%;border-radius: 5px;" class="flexs">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                                <form method="post" action="{{ route('sendClients') }}" id="updateProfileForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <input type="hidden" name="type" value="clients" class="form-control col-sm-3"/>
