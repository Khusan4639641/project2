...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Income Comment</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Income</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-home-tab1" data-toggle="pill" href="#custom-tabs-four-home1" role="tab" aria-controls="custom-tabs-four-home1" aria-selected="false">Active Incomes</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            ...
                            @foreach($sliders as $val)
                                <tr>
                                    ...
                                    <td>{{ $val->text }}</td>
                                    <td>
                                        <a href="/home/income/visible/{{ $val->id }}" class="btn btn-success">Active</a>
                                    </td>
                                    <td>
                                        <a href="/home/income/Delete/{{ $val->id }}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                <? $num++; ?>
                            @endforeach
                            ...
                            <div class="tab-pane fade show" id="custom-tabs-four-home1" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab1">
                                ...
                                @foreach($sliders_dis as $val)
                                    <tr>
                                        ...
                                        <td>{{ $val->text }}</td>
                                        <td>
                                            <a href="/home/income/re_visible/{{ $val->id }}" class="btn btn-info">Disabled</a>
                                        </td>
                                    </tr>
                                    <? $num1++; ?>
                                @endforeach
