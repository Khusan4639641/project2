                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-home-tab1" data-toggle="pill" href="#custom-tabs-four-home1" role="tab" aria-controls="custom-tabs-four-home1" aria-selected="false">Disable Products</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="custom-tabs-four-messages-tab" data-toggle="pill" href="#custom-tabs-four-messages" role="tab" aria-controls="custom-tabs-four-messages" aria-selected="false">Add Products</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                                <form method="post" action="{{ route('sendProduct') }}" id="updateProfileForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                                <strong>Product name in Ru</strong>
                                                <input onclick='spaceDel(id)' id="header_ru" name="header[ru]" maxlength="255" class="form-control">
                                        </div>
                                        <div class="col-sm-4">
                                            <strong>Product name in Uzbek</strong>
                                                <input id="header_uz" onclick='spaceDel(id)' name="header[uz]" maxlength="255" class="form-control">

                                        </div>
                                        <div class="col-sm-4">
                                            <strong>Product name in English</strong>
                                                <input id="header_en" name="header[en]" onclick='spaceDel(id)' maxlength="255" class="form-control">
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            <strong>Description in Uzbek</strong>
