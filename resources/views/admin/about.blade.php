                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="custom-tabs-four-home-tab2" data-toggle="pill" href="#custom-tabs-four-home2" role="tab" aria-controls="custom-tabs-four-home2" aria-selected="false">About</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-four-tabContent">
                            <div class="tab-pane fade show active" id="custom-tabs-four-home2" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab2">
                                ...
                                <div class="slider" id="sliderId3">
                                    <div class="headers" onclick="sliderShow2('3')">
                                        <p class="slide_p"><strong>1 )</strong>&nbsp;&nbsp;About blog 1</p>
                                    </div>
                                    <div>
                                        <div class="row">
                                ...
                                <div class="slider" id="sliderId4">
                                    <div class="headers" onclick="sliderShow2('4')">
                                        <p class="slide_p"><strong>2 )</strong>&nbsp;&nbsp;About blog 2</p>
                                    </div>
                                    <div>
                                        <div class="row">
                                ...
                                <div class="slider" id="sliderId5">
                                    <div class="headers" onclick="sliderShow2('5')">
                                        <p class="slide_p"><strong>3 )</strong>&nbsp;&nbsp;About blog 3</p>
                                    </div>
                                    <div>
                                        <div class="row">
                                            <div style="width: 100%;padding:0px 10px;">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-four-messages" role="tabpanel" aria-labelledby="custom-tabs-four-messages-tab">
                                <form method="post" action="{{ route('sendAbout') }}" id="updateProfileForm" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
