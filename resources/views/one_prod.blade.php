...
<head>
  ...
  <link href="{{ URL::to('/') }}/assets/vendor/ionicons/css/ionicons.min.css" rel="stylesheet">
      ...
      <div class="container-fluid">
          ...
          <div class="row justify-content-center">
              <div class="col-xl-11 d-flex align-items-center">
                  <h1 class="logo mr-auto"><a href="{{ route('home1') }}">Uzdenim</a></h1>
          ...
          <div class="container">
              ...
              <div class="portfolio-details-container">
                  ...
                  <div class="owl-carousel portfolio-details-carousel">
                    @for($i=0;$i<count($infos->img);$i++)
                      <img src="{{ URL::to('/') }}/media/{{ $infos->img[$i] }}" class="img-fluid" alt="" style="width: 100%

                      ;">
                    @endfor
                  </div>
                  <div class="portfolio-info" style="width:500px;">
                      <p>{{ $infos->short }}</p>
                  </div>
